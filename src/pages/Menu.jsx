import "../assets/css/cueg.css"

export const Menu = () => {
    return(
        <>
            <section className="cueg-section">
                <h1 className="cueg-title">Cómo usar esta Guía</h1>
                ...
                <ul>
                    <li><h3>NOMBRE COMÚN</h3> <p >que es el nombre que se usa en el campo.</p></li>
                    <li><h3>NOMBRE CIENTÍFICO</h3> <p>que es el nombre que utilizan los científicos que estudian animales.</p></li>
                    <li><h3>DESCRIPCIÓN</h3> <p>que es la información sobre la forma, tamaño, color y rasgos distintivos de la serpiente.</p></li>
                    <li><h3>DISTRIBUCIÓN EN GUATEMALA</h3> <p>que señala los departamentos o regiones en los que ocurre la especie en el país.</p></li>
                    <li><h3>HISTORIA NATURAL</h3> <p> donde se explica la forma en que vive la serpiente.</p></li>
                    <li><h3>VENENOSIDAD</h3> <p> que indica qué tan débil o fuerte es el veneno de la serpiente, según el siguiente criterio:
