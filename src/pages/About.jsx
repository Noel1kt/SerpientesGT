...
export const About = () => {
    return( <>
        <section className="about-section">
            ...
            de Dennis Guerra Centeno, Héctor Fuentes Rousselin y David Morán Villatoro. El libro original está diseñado para ser utilizado como una guía rápida para identificar
            ...
            <ul className="about-ul">
                <li><h3>Dennis Guerra Centeno </h3> <p> Médico Veterinario por la Universidad de San Carlos de
                ...
                <li><h3>Héctor Fuentes Rousselin</h3> <p> Médico Veterinario por la Universidad de San Carlos
                ...
                <li><h3>David Morán Villatoro</h3> <p> Médico Veterinario y Maestro en Ciencias en Manejo de
